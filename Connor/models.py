...
class Journals(models.Model):
    TITLE = models.CharField(max_length=500, null=True)  # Dissertation中的PUBLICATI出版物
    TITLE29 = models.CharField(max_length=300, null=True)  # 出版物简写一
    TITLE20 = models.CharField(max_length=300, null=True)  # 出版物简写二
